...
//     switch ($_POST['action']) {
//         case 'createSchool':
//             echo createSchool($_POST['name']) ? "School created successfully" : "Failed to create school";
//             break;
//         case 'createClass':
//             echo createClass($_POST['schoolId'], $_POST['name']) ? "Class created successfully" : "Failed to create class";
//             break;
//         case 'createStudent':
//             echo createStudent($_POST['classId'], $_POST['name'], $_POST['dob']) ? "Student created successfully" : "Failed to create student";
//             break;
//         case 'updateStudent':
//             echo updateStudent($_POST['studentId'], $_POST['name'], $_POST['dob']) ? "Student updated successfully" : "Failed to update student";
//             break;
//         case 'deleteStudent':
...
//                                 <td>{$school['name']}</td>
//                                 <td>
//                                     <button onclick='editStudent(\"{$school['school_id']}\")' class='btn btn-sm btn-primary'>Edit</button>
//                                     <button onclick='deleteStudent(\"{$school['school_id']}\")' class='btn btn-sm btn-danger'>Delete</button>
//                                 </td>
//                               </tr>";
//                     }
//                     echo "</tbody></table>";
...
//                     break;
//                 case 'students':
//                     $students = isset($_GET['classId']) ? getStudents($_GET['classId']) : getStudents();
//                     echo "<table class='table table-striped'>
//                             <thead>
//                                 <tr>
//                                     <th>Student ID</th>
