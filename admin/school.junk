  ...
  <body>
    ...
    <div class="toast-container">
      ...
      >
        ...
        <div class="toast-body">School added.</div>
      </div>
    </div>
    ...
    <script>
      $(document).ready(function () {
        ...
        $("#classForm").on("submit", function (event) {
          ...
          if (editingClassId) {
            ...
            classes = classes.map((c) =>
              c.className === editingClassId
                ? { className, schoolId: currentSchoolId }
                : c
            );
            $("#editingClassId").val("");
        ...
        $("#studentForm").on("submit", function (event) {
          ...
          // Show toast notification
          $(".toast-body").text(
            `Student "${data.firstName} ${data.lastName}" added.`
          );
          $(".toast").toast("show");
          ...
          $(".delete-class")
            ...
            .on("click", function () {
              ...
              classes = classes.filter(
                (c) =>
                  c.className !== className || c.schoolId !== currentSchoolId
              );
              renderClassTable();
            });
        }
