...
<body>
    ...
    <script>
        ...
        //             $.post('process.php', { action: 'delete_school', schoolId: schoolId }, function(response) {
        //                 location.reload();
        //             });
        //         }
        //     });
        ...
        //         var schoolId = $(this).data('id');
        //         $.get('get_school.php', { schoolId: schoolId }, function(data) {
        //             var school = JSON.parse(data);
        //             $('#editingSchoolId').val(school.id);
        //             $('#region').val(school.region);
        //             $('#town').val(school.town);
        //             $('#educator').val(school.educator);
        //             $('#schoolName').val(school.school_name);
        //             $('input[name="action"]').val('edit_school');
        //             $('button[type="submit"]').text('Update School');
        //         });
        //     });

        //     // Reset form on new school creation
        //     $('#schoolForm').on('reset', function() {
        //         $('#editingSchoolId').val('');
        //         $('input[name="action"]').val('create_school');
        //         $('button[type="submit"]').text('Add School');
        //     });
        // });
        $(document).ready(function() {
    // Delete School
