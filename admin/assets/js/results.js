...
document.addEventListener('DOMContentLoaded', function () {
   ...
   // SEL Pie Chart
    ...
    const competencyMap = shortForms => shortForms.map(form => shortCompetencyMap[form] || form);
    ...
    new Chart(selPieChart, {
        ...
        data: {
            ...
            datasets: [{
                data: selData,
                backgroundColor: ['#296BBF', '#DA6C11', '#81807E', '#FACD05', '#56A5F5'],
                hoverOffset: 10
            }]
        },
        options: {
