            ...
            <table class="table table-striped table-hover">
                ...
                <?php foreach ($students as $student): ?>
                    <tr>
                        ...
                        <td>
                            <!-- View Button -->
                            <a href="view_historical_report.php?student_id=<?php echo $student['student_id']; ?>&term_id=<?php echo $student['term_id']; ?>" class="btn btn-primary action-button">View</a>
                            <!-- Generate Button -->
                            <button id="generate-<?php echo $student['student_id']; ?>-<?php echo $student['term_id']; ?>" onclick="generateReport('<?php echo $student['student_id']; ?>', <?php echo $student['term_id']; ?>)" class="btn btn-secondary action-button">Generate</button>
                            <!-- Download Button -->
                            <button id="download-<?php echo $student['student_id']; ?>-<?php echo $student['term_id']; ?>" onclick="downloadReport('<?php echo $student['student_id']; ?>', <?php echo $student['term_id']; ?>)" class="btn btn-success action-button" disabled>Download</button>
                            <!-- Send Button -->
                            <button id="whatsApp-<?php echo $student['student_id']; ?>-<?php echo $student['term_id']; ?>" onclick="sendWhatsApp('<?php echo $student['student_id']; ?>', <?php echo $student['term_id']; ?>)" class="btn btn-warning action-button" disabled>Send</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
