...
<body>
                    ...
                    <div class="col-auto">
                        <select name="school_id" id="school_id" class="form-select" onchange="this.form.submit()">
                            ...
                            <option value="<?php echo $school['id']; ?>"
                                ...
                                <?php echo htmlspecialchars($school['school_name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number"
                                        name="scores[<?php echo $student_id; ?>][<?php echo $theme['theme_id']; ?>]"
                                        max="10" step="1" class="form-control score-input validate-score"
                                        value="<?php echo $score !== null ? htmlspecialchars(round($score)) : ''; ?>">
        ...
        <div id="view-scores-view" style="display: none;">
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-auto">
                        <select class="form-select" name="view_school_id" id="view_school_id">
                            ...
                            <option value="<?php echo $school['id']; ?>"
                                <?php echo (isset($_GET['view_school_id']) && $_GET['view_school_id'] == $school['id']) ? 'selected' : ''; ?>>
                                <?php echo htmlspecialchars($school['school_name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="col-auto">
                        <select name="view_class_id" id="view_class_id" class="form-select">
                            ...
                            <option value="<?php echo $class['class_id']; ?>"
                                <?php echo (isset($_GET['view_class_id']) && $_GET['view_class_id'] == $class['class_id']) ? 'selected' : ''; ?>>
                                <?php echo htmlspecialchars($class['class_name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="col-auto">
                        <select class="form-select" name="academic_year_id" id="academic_year_id"
                            ...
                            <option value="<?php echo $year['id']; ?>"
                                ...
                                <?php echo htmlspecialchars($year['year_name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="col-auto">
                        <input type="text" name="search" id="student-search" class="form-control search-input"
                            placeholder="Search by ID or Name" value="<?php echo htmlspecialchars($searchQuery); ?>">
                    </div>
            ...
            <div id="students-table-container">
                <table id="students-table">
                    ...
                    <tr>
                        <td><input type="checkbox" class="student-select" value="<?php echo $student['student_id']; ?>">
                        </td>
                        ...
                        <td>
                            <a target="_blank" rel="noopener noreferrer"
                                href="view_report.php?student_id=<?php echo $student['student_id']; ?>&term_id=<?php echo $term_id; ?>">View</a>
                        </td>
                        <td>
                            <button id="generate-<?php echo $student['student_id']; ?>-<?php echo $term_id; ?>"
                                onclick="generateReport('<?php echo $student['student_id']; ?>', <?php echo $term_id; ?>)"
                                class="action-button">Generate</button>
                            <button id="download-<?php echo $student['student_id']; ?>-<?php echo $term_id; ?>"
                                onclick="downloadReport('<?php echo $student['student_id']; ?>', <?php echo $term_id; ?>)"
                                class="action-button" disabled>Download</button>
                            <button id="whatsApp-<?php echo $student['student_id']; ?>-<?php echo $term_id; ?>"
                                onclick="sendWhatsApp('<?php echo $student['student_id']; ?>', <?php echo $term_id; ?>)"
    ...
    function monitorQueueStatus() {
        ...
        toastr.info('Starting queue...', 'Queue Started', {
            timeOut: 2000
        });
    ...
    function sendWhatsAppMessages(studentIds, termId, whatsAppButton) {
        fetch('send_whatsapp.php', {
            ...
            .catch(error => {
                ...
                toastr.error('An error occurred while adding to queue: ' + error.message);
            });
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validateScore(event) {
            ...
            if (value === '' || (value >= 1 && value <= 10)) {
                ...
                errorSpan.textContent = 'Score must be between 1 and 10 or left empty.';
